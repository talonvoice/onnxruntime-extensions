...
class CmdBuildCMakeExt(_build_ext):
    ...
    def build_cmake(self, extension):
        ...
        cmake_args += '-A x64 -DOCOS_ENABLE_SELECTED_OPLIST=OFF -DOCOS_ONNXRUNTIME_VERSION=1.20.1 -DOCOS_ENABLE_RE2_REGEX=OFF -DOCOS_ENABLE_GPT2_TOKENIZER=OFF -DOCOS_ENABLE_TRIE_TOKENIZER=OFF -DOCOS_ENABLE_SPM_TOKENIZER=OFF -DOCOS_ENABLE_WORDPIECE_TOKENIZER=ON -DOCOS_ENABLE_BERT_TOKENIZER=OFF -DOCOS_ENABLE_BLINGFIRE=OFF -DOCOS_ENABLE_MATH=OFF -DOCOS_ENABLE_DLIB=OFF -DOCOS_ENABLE_OPENCV_CODECS=OFF -DOCOS_ENABLE_CV2=OFF -DOCOS_ENABLE_VISION=OFF -DOCOS_ENABLE_AUDIO=OFF -DOCOS_BUILD_SHARED_LIB=OFF'.split(' ')
